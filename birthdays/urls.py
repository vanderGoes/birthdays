...
urlpatterns = [
    ...
    url(r'^first-names/(?P<slug>[a-z0-9\-]*)/?', ontology_views.first_name_view, name="firstname_view"),
    url(r'^last-names/(?P<slug>[a-z0-9\-]*)/?', ontology_views.last_name_view, name="lastname_view"),
